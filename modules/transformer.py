...
class Transformer:
    ...
    def __init__(self):
        # Initialization message for the Transformer object
    ...
    def get_longitudes_latitudes(self):
        ...
        self.properties_info_df_clean['code_postal'] = self.properties_info_df_clean['code_postal'].astype(str)
        ...
        self.cities_df['code_postal'] = self.cities_df['code_postal'].apply(lambda x: x.zfill(5))
